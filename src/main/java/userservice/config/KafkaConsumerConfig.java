...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UserInfoDTO> consumerFactory() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "13.205.147.251:9092");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "userinfo-consumer-group");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, userservice.deserializer.UserInfoDtoDeserializer.class);
